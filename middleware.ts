...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    "font-src 'self' data:; " +
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.arbitrum.io https://*.ethereum.org https://*.walletconnect.com https://api.mixpanel.com https://*.mixpanel.com; " +
