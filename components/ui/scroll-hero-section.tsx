...
function WordHeroPage({
  ...
  // Set CSS variables synchronously before paint to prevent layout shift
  useLayoutEffect(() => {
  ...
  }, [theme, animate, debug, hue, accentColor]);
  ...
  return (
    ...
    >
      ...
      {/* Footer with Testnet Launch Message */}
      <footer className="page-footer">
        <div className="testnet-launch-message">
          <p>
            MegaETH testnet just launched{' '}
            <a
