...
export default function RadialOrbitalTimeline({
  ...
  const handleNodeHover = (id: number) => {
    setExpandedItems((prev) => {
      ...
      // Don't call centerViewOnNode to keep the component still
  ...
  useEffect(() => {
    const updateRadius = () => {
      if (typeof window !== "undefined") {
        ...
        // Use smaller radius on mobile/tablet, larger on desktop
        if (width < 640) {
          // Mobile: very close to center
          setRadius(110);
        } else if (width < 1024) {
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      {/* <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-orange-500 to-[#FF3A1E]"
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  onMouseEnter={() => handleNodeHover(relatedId)}
                                  onMouseLeave={handleNodeLeave}
                                >
                                  {relatedItem?.title}
                                  <ArrowRight
