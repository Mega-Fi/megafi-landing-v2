...
// Use OG NFT contract for this endpoint
...
export async function GET() {
    ...
    return NextResponse.json(
      {
        ...
        details: "NEXT_PUBLIC_CONTRACT_ADDRESS_OG environment variable is not set",
        latestTokenId: 0,
        nextTokenId: 1,
      },
      { status: 500 }
  ...
  try {
    ...
    // Call getCurrentTokenId() on the OG NFT contract
    ...
    console.error("Error fetching latest token ID from OG NFT contract:", error);
